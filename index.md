...
In our project on fraud detection, we are trying to figure out, based on given data, which applicants for a bank loan are more likely to default on the given loan. 
